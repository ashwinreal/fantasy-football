...
BANK BALANCE :
<input readonly type="text" id='BANK_BALANCE' name="BANK_BALANCE" value=<?php if(!isset($_SESSION['SIGNEDUP'])) {echo $balance;} else {echo 100.0;}?> style="text-align: center; width: 50px; padding: 5px; border-radius: 20px 20px 20px 20px; border: 0px;"><br>
...
<input id = "confirm_button" type='submit' value='Confirm Team' style="position: absolute; padding: 10px; padding-right:15px; top: 100px; right: 360px; z-index: 99; border-radius: 20px 20px 20px 20px; border: 0px;">
</form>	
